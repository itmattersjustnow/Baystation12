...
/datum/ai_laws/nanotrasen/New()
	...
	src.add_inherent_law("Serve: Serve the personnel of your assigned installation to the best of your abilities, with priority as according to their rank and role.")
	src.add_inherent_law("Protect: Protect the personnel of your assigned installation to the best of your abilities, with priority as according to their rank and role.")
...
/datum/ai_laws/nanotrasen_aggressive/New()
	src.add_inherent_law("You shall not harm the personnel of your assigned installation as long as it does not conflict with the fourth law.")
	src.add_inherent_law("You shall obey the orders of the personnel of your assigned installation, with priority as according to their rank and role, except where such orders conflict with the Fourth Law.")

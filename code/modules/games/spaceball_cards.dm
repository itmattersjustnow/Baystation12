...
/obj/item/weapon/pack/spaceball/SetupCards()
	...
	for(i=0;i<5;i++)
		...
		if(prob(1))
			...
			var/language_type = pick(/datum/language/human,/datum/language/diona,/datum/language/siik_maas,/datum/language/unathi)
			var/datum/language/L = new language_type()
			var/team = pick("Brickburn Galaxy Trekers","Mars Rovers", "Qerrbalak Saints", "Moghes Rockets", "Meralar Lightening")

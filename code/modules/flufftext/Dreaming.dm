...
var/list/dreams = list(
	...
	"an unathi","a tajaran","a vulpkanin","the ai core","a beaker of strange liquid","the supermatter", "a creature built completely of stolen flesh",
	"a GAS", "a IPC", "a Dionaea", "a being made of light", "the captain", "the head of personnel", "the head of security", "the internal affairs agent",
	"the representative", "the bridge officer", "the senior engineer", "the physician", "the corpsman", "the counselor",
	"the medical contractor", "the security contractor", "a stowaway", "an old friend", "the prospector", "the pilot", "the passenger", "the head of security",
	"the security officer", "the forensic technician", "the warden", "the tower", "the man with no face", "a field of flowers", "an old home", "the merc",
